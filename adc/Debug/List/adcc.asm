...
; 0000 002C DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0031 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 0032 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(3)
	OUT  0x11,R30
; 0000 0033 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 0077 // ADC Clock frequency: 125.000 kHz
; 0000 0078 // ADC Voltage Reference: Int., cap. on AREF
; 0000 0079 // ADC Auto Trigger Source: ADC Stopped
; 0000 007A ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(192)
	OUT  0x7,R30
; 0000 007B ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
_0x6:
; 0000 0087       {
; 0000 0088         read_adc(3);
	LDI  R26,LOW(3)
	RCALL _read_adc
; 0000 0089         PORTC = ADCL;
	IN   R30,0x4
	OUT  0x15,R30
; 0000 008A         PORTD = ADCH;
	IN   R30,0x5
	OUT  0x12,R30
; 0000 008B       }
	RJMP _0x6
