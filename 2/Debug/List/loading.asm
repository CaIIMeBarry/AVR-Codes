...
_0x0:
	.DB  0x25,0x33,0x64,0x25,0x25,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0016             sprintf(percent_str, "%3d%%", percent);
	SBIW R28,2
;	bars -> Y+0
	LDI  R30,LOW(_percent_str)
	LDI  R31,HIGH(_percent_str)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 0018             lcd_puts(percent_str);
	LDI  R26,LOW(_percent_str)
	LDI  R27,HIGH(_percent_str)
	RCALL _lcd_puts
; 0000 0019             ///////////////////////////
...
; 0000 001E                 bar_str[i] = (i < bars) ? 255 : ' ';
	MOVW R26,R18
	SUBI R26,LOW(-_bar_str)
	SBCI R27,HIGH(-_bar_str)
	LD   R30,Y
	LDD  R31,Y+1
	CP   R18,R30
	CPC  R19,R31
...
; 0000 0022             lcd_puts(bar_str);
	LDI  R26,LOW(_bar_str)
	LDI  R27,HIGH(_bar_str)
	RCALL _lcd_puts
