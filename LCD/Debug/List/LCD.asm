...
; 0000 009B         lcd_clear();
	RCALL SUBOPT_0x0
; 0000 009C         lcd_gotoxy(x,0);
; 0000 009D         lcd_putsf("IRAN");
; 0000 009E         delay_ms(300);
; 0000 009F         }
	INC  R5
	RJMP _0x7
_0x8:
; 0000 00A0 
; 0000 00A1         for(x=12;x<+0;x--)
	LDI  R30,LOW(12)
	MOV  R5,R30
_0xA:
	LDI  R30,LOW(0)
...
; 0000 00A3         lcd_clear();
	RCALL SUBOPT_0x0
; 0000 00A4         lcd_gotoxy(x,0);
; 0000 00A5         lcd_putsf("IRAN");
