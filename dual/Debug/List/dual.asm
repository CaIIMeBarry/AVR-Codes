...
_0x0:
	.DB  0x41,0x3A,0x25,0x34,0x2E,0x31,0x66,0x20
	.DB  0x0,0x42,0x3A,0x25,0x34,0x2E,0x31,0x66
	.DB  0x0,0x46,0x61,0x6E,0x3A,0x20,0x4F,0x4E
	.DB  0x20,0x20,0x20,0x0,0x46,0x61,0x6E,0x3A
	.DB  0x20,0x4F,0x46,0x46,0x20,0x20,0x0
_0x2000000:
...
; 0000 00A4         sprintf(temp_str2, "B:%4.1f", temp_2);
	LDI  R30,LOW(_temp_str2)
	LDI  R31,HIGH(_temp_str2)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,9
	ST   -Y,R31
...
; 0000 00A8             sprintf(fan_str, "Fan: ON   ");
	LDI  R30,LOW(_fan_str)
	LDI  R31,HIGH(_fan_str)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,17
	RJMP _0x10
...
; 0000 00B1         lcd_puts(temp_str2);
	LDI  R26,LOW(_temp_str2)
	LDI  R27,HIGH(_temp_str2)
	CALL _lcd_puts
...
; 0000 00B3         lcd_puts(fan_str);
	LDI  R26,LOW(_fan_str)
	LDI  R27,HIGH(_fan_str)
	CALL _lcd_puts
; 0000 00B4 
