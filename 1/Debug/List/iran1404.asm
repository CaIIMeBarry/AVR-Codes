...
_0x0:
	.DB  0x49,0x52,0x41,0x4E,0x0,0x31,0x34,0x30
	.DB  0x34,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0084         lcd_clear();
	RCALL _lcd_clear
; 0000 0085         lcd_gotoxy(x1, 0);
	ST   -Y,R5
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0086         lcd_putsf("IRAN");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 0087         lcd_gotoxy(x2, 1);
	ST   -Y,R4
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0088         lcd_putsf("1404");
	__POINTW2FN _0x0,5
	RCALL _lcd_putsf
; 0000 0089 
; 0000 008A         x1++;
...
; 0000 008B         x2--;
	DEC  R4
; 0000 008C 
; 0000 008D         // Reset positions when out of bounds
; 0000 008E         if (x1 > 12) x1 = 0;     // Loop "IRAN" back to start
	LDI  R30,LOW(12)
	CP   R30,R5
	BRGE _0x6
	CLR  R5
; 0000 008F         if (x2 < 0) x2 = 12;    // Loop "1404" back to start
_0x6:
	LDI  R30,LOW(0)
	CP   R4,R30
	BRGE _0x7
	...
	MOV  R4,R30
; 0000 0090 
; 0000 0091         // Delay for smooth scrolling
