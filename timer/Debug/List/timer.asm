...
; 0000 0024 // Clock source: T0 pin Falling Edge
; 0000 0025 // Mode: Normal top=0xFF
; 0000 0026 // OC0 output: Disconnected
; 0000 0027 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(6)
	OUT  0x33,R30
...
_0x3:
; 0000 0070       {
; 0000 0071       PORTA = TCNT0;
	IN   R30,0x32
	OUT  0x1B,R30
; 0000 0072       if(TCNT0 ==10)TCNT0=253;
	IN   R30,0x32
	CPI  R30,LOW(0xA)
	BRNE _0x6
	LDI  R30,LOW(253)
