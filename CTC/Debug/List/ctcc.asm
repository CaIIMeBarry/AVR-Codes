...
; 0000 0019 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 001E // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 001F DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(128)
	OUT  0x11,R30
; 0000 0020 // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0045 // Clock value: 125.000 kHz
; 0000 0046 // Mode: CTC top=OCR2A
; 0000 0047 // OC2 output: Toggle on compare match
; 0000 0048 // Timer Period: 8 us
; 0000 0049 // Output Pulse(s):
; 0000 004A // OC2 Period: 0.016 ms Width: 8 us
; 0000 004B ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 004C TCCR2=(0<<PWM2) | (0<<COM21) | (1<<COM20) | (1<<CTC2) | (0<<CS22) | (1<<CS21) | (0<<CS20);
	LDI  R30,LOW(26)
	OUT  0x25,R30
...
_0x3:
; 0000 0074       {
; 0000 0075       if(PIND.2==0&&OCR2<254)
	SBIC 0x10,2
	RJMP _0x7
	IN   R30,0x23
	CPI  R30,LOW(0xFE)
