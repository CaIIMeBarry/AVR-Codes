...
; 0000 0038 unsigned char adc_value;
...
; 0000 008B // USART Baud Rate: 1200
...
; 0000 009B // ADC Clock frequency: 125.000 kHz
; 0000 009C // ADC Voltage Reference: AVCC pin
...
; 0000 00A0 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 00A1 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
_0x6:
; 0000 00AD       {
; 0000 00AE        adc_value = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOV  R17,R30
; 0000 00AF        while ((UCSRA & (1<<UDRE)) == 0);
_0x9:
	SBIS 0xB,5
	RJMP _0x9
; 0000 00B0        UDR = adc_value;
	OUT  0xC,R17
