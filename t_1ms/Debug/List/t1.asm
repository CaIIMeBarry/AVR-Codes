...
;http://www.hpinfotech.com
;
;Project : Pulse Generator (10ms HIGH, 990ms OFF)
;Version :
;Date    : 9/5/2025
;Author  :
;Company :
;Comments: Generates a pulse with 10ms high and 990ms off period
;
;
;Chip type               : ATmega32
;Program type            : Application
...
; 0000 0053 // Timer Period: 1 ms
; 0000 0054 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(2)
	OUT  0x33,R30
