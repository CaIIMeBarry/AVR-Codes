...
;unsigned char d[]={0x02,0x04,0x08,0x10};
...
; 0000 003E // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=In
; 0000 003F DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(30)
	OUT  0x17,R30
; 0000 0040 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=T
...
; 0000 007D // INT0: On
; 0000 007E // INT0 Mode: Low level
; 0000 007F // INT1: On
; 0000 0080 // INT1 Mode: Low level
; 0000 0081 // INT2: Off
; 0000 0082 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
...
; 0000 0084 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0085 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0086 
