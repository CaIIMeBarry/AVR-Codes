...
_0x0:
	.DB  0x54,0x45,0x53,0x54,0x0,0x32,0x34,0x0
	.DB  0x62,0x61,0x72,0x64,0x69,0x61,0x61,0x61
	.DB  0x61,0x61,0x61,0x61,0x0
__RESET:
	CLI
	CLR  R30
	OUT  EECR,R30
...
; 0000 0029 OCR0=0x00;
	OUT  0x3C,R30
; 0000 002A 
; 0000 002B TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 002C TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	OUT  0x2E,R30
; 0000 002D TCNT1H=0x00;
	OUT  0x2D,R30
; 0000 002E TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 002F ICR1H=0x00;
	OUT  0x27,R30
; 0000 0030 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0031 OCR1AH=0x00;
	OUT  0x2B,R30
; 0000 0032 OCR1AL=0x00;
	OUT  0x2A,R30
; 0000 0033 OCR1BH=0x00;
	OUT  0x29,R30
; 0000 0034 OCR1BL=0x00;
	OUT  0x28,R30
; 0000 0035 
; 0000 0036 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0037 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 004F // The Analog Comparator's positive input is
; 0000 0050 // connected to the AIN0 pin
; 0000 0051 // The Analog Comparator's negative input is
; 0000 0052 // connected to the AIN1 pin
...
_0x3:
; 0000 0063       {
; 0000 0064         if(PINB.0==0)
	SBIC 0x16,0
	RJMP _0x6
; 0000 0065         {
; 0000 0066         putsf("TEST");
	__POINTW2FN _0x0,0
	CALL SUBOPT_0x0
; 0000 0067         putchar(13);
; 0000 0068         putchar(10);
...
; 0000 006D         putsf("24");
	__POINTW2FN _0x0,5
	CALL SUBOPT_0x0
; 0000 006E         putchar(13);
; 0000 006F         putchar(10);
...
_0x7:
	...
	RJMP _0x8
; 0000 0073         {
; 0000 0074         putsf("bardiaaaaaaa");
	__POINTW2FN _0x0,8
	CALL SUBOPT_0x0
; 0000 0075         putchar(13);
; 0000 0076         putchar(10);
